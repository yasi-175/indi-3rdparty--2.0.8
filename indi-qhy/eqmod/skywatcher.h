...
#define QHY_PROTOCOL_SPEED_UNITS_PER_KHZ 100000.0
#define QHY_AXIS_STEPS_PER_REVOLUTION 5120000.0
#define QHY_DEGREES_PER_REVOLUTION 360.0
#define QHY_ARCSEC_PER_DEGREE 3600.0
#define QHY_MOTOR_HZ_PER_KHZ 1000.0
#define QHY_ARCSEC_PER_MOTOR_HZ (QHY_DEGREES_PER_REVOLUTION * QHY_ARCSEC_PER_DEGREE / QHY_AXIS_STEPS_PER_REVOLUTION)
#define QHY_SIDEREAL_MOTOR_HZ 59.4215
#define QHY_SLEW_HIGH_SPEED_THRESHOLD_KHZ QHY_MIN_FREQUENCY_KHZ
#define QHY_TRACK_HIGH_SPEED_THRESHOLD_KHZ 0.3
