...
#define BRESSERCAM_CONTRAST_MIN             (-150)  /* contrast */
#define BRESSERCAM_CONTRAST_MAX             150     /* contrast */
...
#define BRESSERCAM_TEC_TARGET_MIN           (-500)  /* TEC target: -50.0 degrees Celsius */
#define BRESSERCAM_TEC_TARGET_DEF           100     /* 10.0 degrees Celsius */
...
/*  for pull mode: BRESSERCAM_EVENT_STILLIMAGE, and then Bressercam_PullStillImageXXXX/Bressercam_PullImageV3
...
#define BRESSERCAM_OPTION_RAW                    0x04       /* raw data mode, read the sensor "raw" data. This can be set only while camea is NOT running. 0 = rgb, 1 = raw, default value: 0 */
#define BRESSERCAM_OPTION_HISTOGRAM              0x05       /* 0 = only one, 1 = continue mode */
#define BRESSERCAM_OPTION_BITDEPTH               0x06       /* 0 = 8 bits mode, 1 = 16 bits mode, subset of BRESSERCAM_OPTION_PIXEL_FORMAT */
#define BRESSERCAM_OPTION_FAN                    0x07       /* 0 = turn off the cooling fan, [1, max] = fan speed, , set to "-1" means to use default fan speed */
#define BRESSERCAM_OPTION_TEC                    0x08       /* 0 = turn off the thermoelectric cooler, 1 = turn on the thermoelectric cooler */
#define BRESSERCAM_OPTION_LINEAR                 0x09       /* 0 = turn off the builtin linear tone mapping, 1 = turn on the builtin linear tone mapping, default value: 1 */
#define BRESSERCAM_OPTION_CURVE                  0x0a       /* 0 = turn off the builtin curve tone mapping, 1 = turn on the builtin polynomial curve tone mapping, 2 = logarithmic curve tone mapping, default value: 2 */
#define BRESSERCAM_OPTION_TRIGGER                0x0b       /* 0 = video mode, 1 = software or simulated trigger mode, 2 = external trigger mode, 3 = external + software trigger, 4 = self trigger, default value = 0 */
#define BRESSERCAM_OPTION_RGB                    0x0c       /* 0 => RGB24; 1 => enable RGB48 format when bitdepth > 8; 2 => RGB32; 3 => 8 Bits Grey (only for mono camera); 4 => 16 Bits Grey (only for mono camera when bitdepth > 8); 5 => 64(RGB64) */
#define BRESSERCAM_OPTION_COLORMATIX             0x0d       /* enable or disable the builtin color matrix, default value: 1 */
#define BRESSERCAM_OPTION_WBGAIN                 0x0e       /* enable or disable the builtin white balance gain, default value: 1 */
#define BRESSERCAM_OPTION_TECTARGET              0x0f       /* get or set the target temperature of the thermoelectric cooler, in 0.1 degree Celsius. For example, 125 means 12.5 degree Celsius, -35 means -3.5 degree Celsius. Set "-2730" or below means using the default for that model */
#define BRESSERCAM_OPTION_AUTOEXP_POLICY         0x10       /* auto exposure policy:
                                                             0: Exposure Only
                                                             ...
                                                             default value: 1
                                                         */
#define BRESSERCAM_OPTION_FRAMERATE              0x11       /* limit the frame rate, range=[0, 63], the default value 0 means no limit */
...
#define BRESSERCAM_OPTION_MULTITHREAD            0x16       /* multithread image processing */
#define BRESSERCAM_OPTION_BINNING                0x17       /* binning
                                                                0x01: (no binning)
                                                         ...
                                                         */
#define BRESSERCAM_OPTION_ROTATE                 0x18       /* rotate clockwise: 0, 90, 180, 270 */
#define BRESSERCAM_OPTION_CG                     0x19       /* Conversion Gain:
                                                                0 = LCG
                                                                1 = HCG
                                                                2 = HDR (for camera with flag BRESSERCAM_FLAG_CGHDR)
                                                                2 = MCG (for camera with flag BRESSERCAM_FLAG_GHOPTO)
                                                         */
#define BRESSERCAM_OPTION_PIXEL_FORMAT           0x1a       /* pixel format, BRESSERCAM_PIXELFORMAT_xxxx */
#define BRESSERCAM_OPTION_FFC                    0x1b       /* flat field correction
                                                             set:
                                                                  0: disable
                                                                  1: enable
                                                                 -1: reset
                                                         ...
                                                         */
#define BRESSERCAM_OPTION_DDR_DEPTH              0x1c       /* the number of the frames that DDR can cache
                                                         ...
                                                         */
#define BRESSERCAM_OPTION_DFC                    0x1d       /* dark field correction
                                                             set:
                                                                 0: disable
                                                                 1: enable
                                                                -1: reset
                                                             ...
                                                             get:
                                                                 ...
                                                                 ((val & 0xff0000) >> 16): average number
                                                         */
#define BRESSERCAM_OPTION_SHARPENING             0x1e       /* Sharpening: (threshold << 24) | (radius << 16) | strength)
                                                             strength: [0, 500], default: 0 (disable)
                                                             radius: [1, 10]
                                                             threshold: [0, 255]
                                                         */
#define BRESSERCAM_OPTION_FACTORY                0x1f       /* restore the factory settings */
#define BRESSERCAM_OPTION_TEC_VOLTAGE            0x20       /* get the current TEC voltage in 0.1V, 59 mean 5.9V; readonly */
#define BRESSERCAM_OPTION_TEC_VOLTAGE_MAX        0x21       /* TEC maximum voltage in 0.1V */
#define BRESSERCAM_OPTION_DEVICE_RESET           0x22       /* reset usb device, simulate a replug */
#define BRESSERCAM_OPTION_UPSIDE_DOWN            0x23       /* upsize down:
                                                             1: yes
                                                             0: no
                                                             default: 1 (win), 0 (linux/macos)
                                                         */
#define BRESSERCAM_OPTION_FOCUSPOS               0x24       /* focus positon */
#define BRESSERCAM_OPTION_AFMODE                 0x25       /* auto focus mode, see BressercamAFMode */
#define BRESSERCAM_OPTION_AFSTATUS               0x27       /* auto focus status, see BressercamAFStaus */
#define BRESSERCAM_OPTION_TESTPATTERN            0x28       /* test pattern:
                                                            0: off
                                                         ...
                                                         */
#define BRESSERCAM_OPTION_AUTOEXP_THRESHOLD      0x29       /* threshold of auto exposure, default value: 5, range = [2, 15] */
...
#define BRESSERCAM_OPTION_FRONTEND_DEQUE_LENGTH  0x31       /* frontend (raw) frame buffer deque length, range: [2, 1024], default: 4
                                                            All the memory will be pre-allocated when the camera starts, so, please attention to memory usage
                                                         */
#define BRESSERCAM_OPTION_FRAME_DEQUE_LENGTH     0x31       /* alias of BRESSERCAM_OPTION_FRONTEND_DEQUE_LENGTH */
#define BRESSERCAM_OPTION_MIN_PRECISE_FRAMERATE  0x32       /* get the precise frame rate minimum value in 0.1 fps, such as 15 means 1.5 fps */
#define BRESSERCAM_OPTION_SEQUENCER_ONOFF        0x33       /* sequencer trigger: on/off */
#define BRESSERCAM_OPTION_SEQUENCER_NUMBER       0x34       /* sequencer trigger: number, range = [1, 255] */
#define BRESSERCAM_OPTION_SEQUENCER_EXPOTIME     0x01000000 /* sequencer trigger: exposure time, iOption = BRESSERCAM_OPTION_SEQUENCER_EXPOTIME | index, iValue = exposure time
                                                         ...
                                                         */
#define BRESSERCAM_OPTION_SEQUENCER_EXPOGAIN     0x02000000 /* sequencer trigger: exposure gain, iOption = BRESSERCAM_OPTION_SEQUENCER_EXPOGAIN | index, iValue = gain */
#define BRESSERCAM_OPTION_DENOISE                0x35       /* denoise, strength range: [0, 100], 0 means disable */
#define BRESSERCAM_OPTION_HEAT_MAX               0x36       /* get maximum level: heat to prevent fogging up */
#define BRESSERCAM_OPTION_HEAT                   0x37       /* heat to prevent fogging up */
#define BRESSERCAM_OPTION_LOW_NOISE              0x38       /* low noise mode (Higher signal noise ratio, lower frame rate): 1 => enable */
#define BRESSERCAM_OPTION_POWER                  0x39       /* get power consumption, unit: milliwatt */
#define BRESSERCAM_OPTION_GLOBAL_RESET_MODE      0x3a       /* global reset mode */
#define BRESSERCAM_OPTION_OPEN_ERRORCODE         0x3b       /* get the open camera error code */
#define BRESSERCAM_OPTION_FLUSH                  0x3d       /* 1 = hard flush, discard frames cached by camera DDR (if any)
                                                         ...
                                                         */
#define BRESSERCAM_OPTION_NUMBER_DROP_FRAME      0x3e       /* get the number of frames that have been grabbed from the USB but dropped by the software */
#define BRESSERCAM_OPTION_DUMP_CFG               0x3f       /* 0 = when camera is stopped, do not dump configuration automatically
                                                            1 = when camera is stopped, dump configuration automatically
                                                            -1 = explicitly dump configuration once
                                                            default: 1
                                                         */
#define BRESSERCAM_OPTION_DEFECT_PIXEL           0x40       /* Defect Pixel Correction: 0 => disable, 1 => enable; default: 1 */
#define BRESSERCAM_OPTION_BACKEND_DEQUE_LENGTH   0x41       /* backend (pipelined) frame buffer deque length (Only available in pull mode), range: [2, 1024], default: 3
                                                            All the memory will be pre-allocated when the camera starts, so, please attention to memory usage
                                                         */
#define BRESSERCAM_OPTION_LIGHTSOURCE_MAX        0x42       /* get the light source range, [0 ~ max] */
#define BRESSERCAM_OPTION_LIGHTSOURCE            0x43       /* light source */
#define BRESSERCAM_OPTION_HEARTBEAT              0x44       /* Heartbeat interval in millisecond, range = [BRESSERCAM_HEARTBEAT_MIN, BRESSERCAM_HEARTBEAT_MAX], 0 = disable, default: disable */
#define BRESSERCAM_OPTION_FRONTEND_DEQUE_CURRENT 0x45       /* get the current number in frontend deque */
#define BRESSERCAM_OPTION_BACKEND_DEQUE_CURRENT  0x46       /* get the current number in backend deque */
#define BRESSERCAM_OPTION_EVENT_HARDWARE         0x04000000 /* enable or disable hardware event: 0 => disable, 1 => enable; default: disable
                                                         ...
                                                         */
#define BRESSERCAM_OPTION_PACKET_NUMBER          0x47       /* get the received packet number */
#define BRESSERCAM_OPTION_FILTERWHEEL_SLOT       0x48       /* filter wheel slot number */
#define BRESSERCAM_OPTION_FILTERWHEEL_POSITION   0x49       /* filter wheel position:
                                                                set:
                                                                    -1: reset
...
#define BRESSERCAM_OPTION_CHAMBER_HT             0x4c       /* get chamber humidity & temperature:
                                                         ...
                                                         */
#define BRESSERCAM_OPTION_ENV_HT                 0x4d       /* get environment humidity & temperature */
#define BRESSERCAM_OPTION_EXPOSURE_PRE_DELAY     0x4e       /* exposure signal pre-delay, microsecond */
#define BRESSERCAM_OPTION_EXPOSURE_POST_DELAY    0x4f       /* exposure signal post-delay, microsecond */
#define BRESSERCAM_OPTION_AUTOEXPO_CONV          0x50       /* get auto exposure convergence status: 1(YES) or 0(NO), -1(NA) */
#define BRESSERCAM_OPTION_AUTOEXPO_TRIGGER       0x51       /* auto exposure on trigger mode: 0 => disable, 1 => enable; default: 0 */
#define BRESSERCAM_OPTION_LINE_PRE_DELAY         0x52       /* specified line signal pre-delay, microsecond */
#define BRESSERCAM_OPTION_LINE_POST_DELAY        0x53       /* specified line signal post-delay, microsecond */
#define BRESSERCAM_OPTION_TEC_VOLTAGE_MAX_RANGE  0x54       /* get the tec maximum voltage range:
                                                                high 16 bits: max
                                                                low 16 bits: min
                                                         */
...
#define BRESSERCAM_OPTION_GIGETIMEOUT            0x5a       /* For GigE cameras, the application periodically sends heartbeat signals to the camera to keep the connection to the camera alive.
                                                            ...
                                                            When the application is stopped by the debugger, the application cannot create the heartbeat signals
                                                                ...
                                                                default: auto
                                                         */
#define BRESSERCAM_OPTION_EEPROM_SIZE            0x5b       /* get EEPROM size */
...
#define BRESSERCAM_OPTION_AUTOEXP_EXPOTIME_DAMP  0x60       /* Auto exposure damping coefficient: time (thousandths). The larger the damping coefficient, the smoother and slower the exposure time changes */
#define BRESSERCAM_OPTION_AUTOEXP_GAIN_DAMP      0x61       /* Auto exposure damping coefficient: gain (thousandths). The larger the damping coefficient, the smoother and slower the gain changes */
...
#define BRESSERCAM_OPTION_PSEUDO_COLOR_ENABLE    0x65       /* Pseudo: -1 => custom: use startcolor & endcolor to generate the colormap
                                                                    ...
                                                                    23 => turbo
                                                         */
#define BRESSERCAM_OPTION_LOW_POWERCONSUMPTION   0x66       /* Low Power Consumption: 0 => disable, 1 => enable */
#define BRESSERCAM_OPTION_FPNC                   0x67       /* Fix Pattern Noise Correction
                                                             set:
                                                                 0: disable
                                                                 1: enable
                                                                -1: reset
                                                             ...
                                                             get:
                                                                 ...
                                                                 ((val & 0xff0000) >> 16): average number
                                                         */
#define BRESSERCAM_OPTION_OVEREXP_POLICY         0x68       /* Auto exposure over exposure policy: when overexposed,
...
* piValue: output, BRESSERCAM_PIXELFORMAT_xxxx
*/
BRESSERCAM_API(HRESULT)     Bressercam_get_PixelFormatSupport(HBressercam h, char cmd, int* piValue);
BRESSERCAM_API(const char*) Bressercam_get_PixelFormatName(int val);
...
#define BRESSERCAM_IOCONTROLTYPE_GET_INPUT_STATE             0x3c /* Input state: 0 (low level) or 1 (high level) */
#define BRESSERCAM_IOCONTROLTYPE_GET_USER_PULSE_HIGH         0x3e /* User pulse high level time: us */
#define BRESSERCAM_IOCONTROLTYPE_SET_USER_PULSE_HIGH         0x3f
#define BRESSERCAM_IOCONTROLTYPE_GET_USER_PULSE_LOW          0x40 /* User pulse low level time: us */
#define BRESSERCAM_IOCONTROLTYPE_SET_USER_PULSE_LOW          0x41
#define BRESSERCAM_IOCONTROLTYPE_GET_USER_PULSE_NUMBER       0x42 /* User pulse number: default 0 */
#define BRESSERCAM_IOCONTROLTYPE_SET_USER_PULSE_NUMBER       0x43
...
/*
    ...
    when nBitDepth > 8
        nBitCount:  24 => RGB24
                    ...
                    64 => RGB64
*/
BRESSERCAM_API(void)     Bressercam_deBayerV2(unsigned nFourCC, int nW, int nH, const void* input, void* output, unsigned char nBitDepth, unsigned char nBitCount);
...
*/
BRESSERCAM_DEPRECATED
BRESSERCAM_API(void)     Bressercam_deBayer(unsigned nFourCC, int nW, int nH, const void* input, void* output, unsigned char nBitDepth);

typedef void (__stdcall* PBRESSERCAM_DEMOSAIC_CALLBACK)(unsigned nFourCC, int nW, int nH, const void* input, void* output, unsigned char nBitDepth, void* ctxDemosaic);
