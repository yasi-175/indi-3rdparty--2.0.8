...
#define TSCAM_BRIGHTNESS_MIN           (-128)  /* brightness */
#define TSCAM_BRIGHTNESS_MAX           128     /* brightness */
#define TSCAM_CONTRAST_DEF             0       /* contrast */
#define TSCAM_CONTRAST_MIN             (-150)  /* contrast */
#define TSCAM_CONTRAST_MAX             150     /* contrast */
...
#define TSCAM_TEC_TARGET_MIN           (-500)  /* TEC target: -50.0 degrees Celsius */
#define TSCAM_TEC_TARGET_DEF           100     /* 10.0 degrees Celsius */
...
#define TSCAM_DYNAMIC_DEFECT_T1_MAX    100     /* means: 10.0 */
#define TSCAM_DYNAMIC_DEFECT_T1_DEF    13      /* means: 1.3 */
#define TSCAM_DYNAMIC_DEFECT_T2_MIN    0       /* dynamic defect pixel correction, value, means: 0.00 */
#define TSCAM_DYNAMIC_DEFECT_T2_MAX    100     /* means: 1.00 */
#define TSCAM_DYNAMIC_DEFECT_T2_DEF    100
...
/*
    nWaitMS: The timeout interval, in milliseconds. If a nonzero value is specified, the function waits until the image is ok or the interval elapses.
             If nWaitMS is zero, the function does not enter a wait state if the image is not available; it always returns immediately; this is equal to Tscam_PullImageV3.
...
/*  for pull mode: TSCAM_EVENT_STILLIMAGE, and then Tscam_PullStillImageXXXX/Tscam_PullImageV3
...
TSCAM_API(HRESULT)  Tscam_get_RealExpoTime(HTscam h, unsigned* Time); /* in microseconds, based on 50HZ/60HZ/DC */
...
#define TSCAM_OPTION_NOFRAME_TIMEOUT        0x01       /* no frame timeout: 0 => disable, positive value (>= TSCAM_NOFRAME_TIMEOUT_MIN) => timeout milliseconds. default: disable */
#define TSCAM_OPTION_THREAD_PRIORITY        0x02       /* set the priority of the internal thread which grab data from the usb device.
                                                         ...
                                                         */
#define TSCAM_OPTION_PROCESSMODE            0x03       /* obsolete & useless, noop. 0 = better image quality, more cpu usage. this is the default value; 1 = lower image quality, less cpu usage */
#define TSCAM_OPTION_RAW                    0x04       /* raw data mode, read the sensor "raw" data. This can be set only while camea is NOT running. 0 = rgb, 1 = raw, default value: 0 */
#define TSCAM_OPTION_HISTOGRAM              0x05       /* 0 = only one, 1 = continue mode */
#define TSCAM_OPTION_BITDEPTH               0x06       /* 0 = 8 bits mode, 1 = 16 bits mode, subset of TSCAM_OPTION_PIXEL_FORMAT */
#define TSCAM_OPTION_FAN                    0x07       /* 0 = turn off the cooling fan, [1, max] = fan speed, , set to "-1" means to use default fan speed */
...
#define TSCAM_OPTION_TECTARGET              0x0f       /* get or set the target temperature of the thermoelectric cooler, in 0.1 degree Celsius. For example, 125 means 12.5 degree Celsius, -35 means -3.5 degree Celsius. Set "-2730" or below means using the default for that model */
#define TSCAM_OPTION_AUTOEXP_POLICY         0x10       /* auto exposure policy:
                                                             0: Exposure Only
                                                             ...
                                                             default value: 1
                                                         */
#define TSCAM_OPTION_FRAMERATE              0x11       /* limit the frame rate, range=[0, 63], the default value 0 means no limit */
#define TSCAM_OPTION_DEMOSAIC               0x12       /* demosaic method for both video and still image: BILINEAR = 0, VNG(Variable Number of Gradients) = 1, PPG(Patterned Pixel Grouping) = 2, AHD(Adaptive Homogeneity Directed) = 3, EA(Edge Aware) = 4, see https://en.wikipedia.org/wiki/Demosaicing, default value: 0 */
#define TSCAM_OPTION_DEMOSAIC_VIDEO         0x13       /* demosaic method for video */
#define TSCAM_OPTION_DEMOSAIC_STILL         0x14       /* demosaic method for still image */
#define TSCAM_OPTION_BLACKLEVEL             0x15       /* black level */
#define TSCAM_OPTION_MULTITHREAD            0x16       /* multithread image processing */
#define TSCAM_OPTION_BINNING                0x17       /* binning
                                                                0x01: (no binning)
...
#define TSCAM_OPTION_FFC                    0x1b       /* flat field correction
                                                         ...
                                                         */
#define TSCAM_OPTION_DDR_DEPTH              0x1c       /* the number of the frames that DDR can cache
                                                         ...
                                                         */
#define TSCAM_OPTION_DFC                    0x1d       /* dark field correction
                                                             set:
                                                                 0: disable
                                                                 1: enable
                                                                -1: reset
                                                             ...
                                                             get:
                                                                 ...
                                                                 ((val & 0xff0000) >> 16): average number
                                                         */
#define TSCAM_OPTION_SHARPENING             0x1e       /* Sharpening: (threshold << 24) | (radius << 16) | strength)
                                                             strength: [0, 500], default: 0 (disable)
                                                             radius: [1, 10]
                                                             threshold: [0, 255]
                                                         */
#define TSCAM_OPTION_FACTORY                0x1f       /* restore the factory settings */
#define TSCAM_OPTION_TEC_VOLTAGE            0x20       /* get the current TEC voltage in 0.1V, 59 mean 5.9V; readonly */
#define TSCAM_OPTION_TEC_VOLTAGE_MAX        0x21       /* TEC maximum voltage in 0.1V */
#define TSCAM_OPTION_DEVICE_RESET           0x22       /* reset usb device, simulate a replug */
#define TSCAM_OPTION_UPSIDE_DOWN            0x23       /* upsize down:
                                                             1: yes
                                                             0: no
                                                             default: 1 (win), 0 (linux/macos)
                                                         */
#define TSCAM_OPTION_FOCUSPOS               0x24       /* focus positon */
#define TSCAM_OPTION_AFMODE                 0x25       /* auto focus mode, see TscamAFMode */
#define TSCAM_OPTION_AFSTATUS               0x27       /* auto focus status, see TscamAFStaus */
#define TSCAM_OPTION_TESTPATTERN            0x28       /* test pattern:
                                                            0: off
                                                         ...
                                                         */
#define TSCAM_OPTION_AUTOEXP_THRESHOLD      0x29       /* threshold of auto exposure, default value: 5, range = [2, 15] */
#define TSCAM_OPTION_BYTEORDER              0x2a       /* Byte order, BGR or RGB: 0 => RGB, 1 => BGR, default value: 1(Win), 0(macOS, Linux, Android) */
#define TSCAM_OPTION_NOPACKET_TIMEOUT       0x2b       /* no packet timeout: 0 => disable, positive value (>= TSCAM_NOPACKET_TIMEOUT_MIN) => timeout milliseconds. default: disable */
#define TSCAM_OPTION_MAX_PRECISE_FRAMERATE  0x2c       /* get the precise frame rate maximum value in 0.1 fps, such as 115 means 11.5 fps */
#define TSCAM_OPTION_PRECISE_FRAMERATE      0x2d       /* precise frame rate current value in 0.1 fps */
#define TSCAM_OPTION_BANDWIDTH              0x2e       /* bandwidth, [1-100]% */
#define TSCAM_OPTION_RELOAD                 0x2f       /* reload the last frame in trigger mode */
#define TSCAM_OPTION_CALLBACK_THREAD        0x30       /* dedicated thread for callback: 0 => disable, 1 => enable, default: 0 */
#define TSCAM_OPTION_FRONTEND_DEQUE_LENGTH  0x31       /* frontend (raw) frame buffer deque length, range: [2, 1024], default: 4
                                                            All the memory will be pre-allocated when the camera starts, so, please attention to memory usage
                                                         */
#define TSCAM_OPTION_FRAME_DEQUE_LENGTH     0x31       /* alias of TSCAM_OPTION_FRONTEND_DEQUE_LENGTH */
#define TSCAM_OPTION_MIN_PRECISE_FRAMERATE  0x32       /* get the precise frame rate minimum value in 0.1 fps, such as 15 means 1.5 fps */
#define TSCAM_OPTION_SEQUENCER_ONOFF        0x33       /* sequencer trigger: on/off */
#define TSCAM_OPTION_SEQUENCER_NUMBER       0x34       /* sequencer trigger: number, range = [1, 255] */
#define TSCAM_OPTION_SEQUENCER_EXPOTIME     0x01000000 /* sequencer trigger: exposure time, iOption = TSCAM_OPTION_SEQUENCER_EXPOTIME | index, iValue = exposure time
                                                         ...
                                                         */
#define TSCAM_OPTION_SEQUENCER_EXPOGAIN     0x02000000 /* sequencer trigger: exposure gain, iOption = TSCAM_OPTION_SEQUENCER_EXPOGAIN | index, iValue = gain */
#define TSCAM_OPTION_DENOISE                0x35       /* denoise, strength range: [0, 100], 0 means disable */
#define TSCAM_OPTION_HEAT_MAX               0x36       /* get maximum level: heat to prevent fogging up */
#define TSCAM_OPTION_HEAT                   0x37       /* heat to prevent fogging up */
#define TSCAM_OPTION_LOW_NOISE              0x38       /* low noise mode (Higher signal noise ratio, lower frame rate): 1 => enable */
#define TSCAM_OPTION_POWER                  0x39       /* get power consumption, unit: milliwatt */
#define TSCAM_OPTION_GLOBAL_RESET_MODE      0x3a       /* global reset mode */
#define TSCAM_OPTION_OPEN_ERRORCODE         0x3b       /* get the open camera error code */
#define TSCAM_OPTION_FLUSH                  0x3d       /* 1 = hard flush, discard frames cached by camera DDR (if any)
                                                         ...
                                                         */
#define TSCAM_OPTION_NUMBER_DROP_FRAME      0x3e       /* get the number of frames that have been grabbed from the USB but dropped by the software */
#define TSCAM_OPTION_DUMP_CFG               0x3f       /* 0 = when camera is stopped, do not dump configuration automatically
                                                            1 = when camera is stopped, dump configuration automatically
                                                            -1 = explicitly dump configuration once
                                                            default: 1
                                                         */
#define TSCAM_OPTION_DEFECT_PIXEL           0x40       /* Defect Pixel Correction: 0 => disable, 1 => enable; default: 1 */
#define TSCAM_OPTION_BACKEND_DEQUE_LENGTH   0x41       /* backend (pipelined) frame buffer deque length (Only available in pull mode), range: [2, 1024], default: 3
                                                            All the memory will be pre-allocated when the camera starts, so, please attention to memory usage
                                                         */
#define TSCAM_OPTION_LIGHTSOURCE_MAX        0x42       /* get the light source range, [0 ~ max] */
#define TSCAM_OPTION_LIGHTSOURCE            0x43       /* light source */
#define TSCAM_OPTION_HEARTBEAT              0x44       /* Heartbeat interval in millisecond, range = [TSCAM_HEARTBEAT_MIN, TSCAM_HEARTBEAT_MAX], 0 = disable, default: disable */
#define TSCAM_OPTION_FRONTEND_DEQUE_CURRENT 0x45       /* get the current number in frontend deque */
#define TSCAM_OPTION_BACKEND_DEQUE_CURRENT  0x46       /* get the current number in backend deque */
#define TSCAM_OPTION_EVENT_HARDWARE         0x04000000 /* enable or disable hardware event: 0 => disable, 1 => enable; default: disable
                                                         ...
                                                         */
#define TSCAM_OPTION_PACKET_NUMBER          0x47       /* get the received packet number */
#define TSCAM_OPTION_FILTERWHEEL_SLOT       0x48       /* filter wheel slot number */
#define TSCAM_OPTION_FILTERWHEEL_POSITION   0x49       /* filter wheel position:
                                                                set:
                                                                    -1: reset
...
#define TSCAM_OPTION_CHAMBER_HT             0x4c       /* get chamber humidity & temperature:
                                                         ...
                                                         */
#define TSCAM_OPTION_ENV_HT                 0x4d       /* get environment humidity & temperature */
#define TSCAM_OPTION_EXPOSURE_PRE_DELAY     0x4e       /* exposure signal pre-delay, microsecond */
#define TSCAM_OPTION_EXPOSURE_POST_DELAY    0x4f       /* exposure signal post-delay, microsecond */
#define TSCAM_OPTION_AUTOEXPO_CONV          0x50       /* get auto exposure convergence status: 1(YES) or 0(NO), -1(NA) */
#define TSCAM_OPTION_AUTOEXPO_TRIGGER       0x51       /* auto exposure on trigger mode: 0 => disable, 1 => enable; default: 0 */
#define TSCAM_OPTION_LINE_PRE_DELAY         0x52       /* specified line signal pre-delay, microsecond */
#define TSCAM_OPTION_LINE_POST_DELAY        0x53       /* specified line signal post-delay, microsecond */
#define TSCAM_OPTION_TEC_VOLTAGE_MAX_RANGE  0x54       /* get the tec maximum voltage range:
                                                                high 16 bits: max
                                                                low 16 bits: min
                                                         */
#define TSCAM_OPTION_HIGH_FULLWELL          0x55       /* high fullwell capacity: 0 => disable, 1 => enable */
#define TSCAM_OPTION_DYNAMIC_DEFECT         0x56       /* dynamic defect pixel correction:
                                                                threshold, t1: (high 16 bits): [10, 100], means: [1.0, 10.0]
                                                                value, t2: (low 16 bits): [0, 100], means: [0.00, 1.00]
                                                         */
#define TSCAM_OPTION_HDR_KB                 0x57       /* HDR synthesize
                                                                K (high 16 bits): [1, 25500]
                                                                B (low 16 bits): [0, 65535]
                                                                0xffffffff => set to default
                                                         */
#define TSCAM_OPTION_HDR_THRESHOLD          0x58       /* HDR synthesize
                                                                threshold: [1, 4094]
                                                                0xffffffff => set to default
                                                         */
#define TSCAM_OPTION_GIGETIMEOUT            0x5a       /* For GigE cameras, the application periodically sends heartbeat signals to the camera to keep the connection to the camera alive.
                                                            ...
                                                            When the application is stopped by the debugger, the application cannot create the heartbeat signals
                                                                ...
                                                                default: auto
                                                         */
#define TSCAM_OPTION_EEPROM_SIZE            0x5b       /* get EEPROM size */
...
#define TSCAM_OPTION_AUTOEXP_EXPOTIME_DAMP  0x60       /* Auto exposure damping coefficient: time (thousandths). The larger the damping coefficient, the smoother and slower the exposure time changes */
#define TSCAM_OPTION_AUTOEXP_GAIN_DAMP      0x61       /* Auto exposure damping coefficient: gain (thousandths). The larger the damping coefficient, the smoother and slower the gain changes */
...
#define TSCAM_OPTION_FPNC                   0x67       /* Fix Pattern Noise Correction
                                                             set:
                                                                 0: disable
                                                                 1: enable
                                                                -1: reset
                                                             ...
                                                             get:
                                                                 ...
                                                                 ((val & 0xff0000) >> 16): average number
                                                         */
#define TSCAM_OPTION_OVEREXP_POLICY         0x68       /* Auto exposure over exposure policy: when overexposed,
                                                            ...
                                                            Default: 0
                                                         */
#define TSCAM_OPTION_READOUT_MODE           0x69       /* Readout mode: 0 = IWR (Integrate While Read), 1 = ITR (Integrate Then Read) */
#define TSCAM_OPTION_TAILLIGHT              0x6a       /* Turn on/off tail Led light: 0 => off, 1 => on; default: on */
#define TSCAM_OPTION_LENSSTATE              0x6b       /* Load/Save lens state to EEPROM: 0 => load, 1 => save */
#define TSCAM_OPTION_AWB_CONTINUOUS         0x6c       /* Auto White Balance: continuous mode
                                                                0:  disable (default)
...
#define TSCAM_IOCONTROLTYPE_GET_PWM_FREQ                0x19
#define TSCAM_IOCONTROLTYPE_SET_PWM_FREQ                0x1a
#define TSCAM_IOCONTROLTYPE_GET_PWM_DUTYRATIO           0x1b
#define TSCAM_IOCONTROLTYPE_SET_PWM_DUTYRATIO           0x1c
#define TSCAM_IOCONTROLTYPE_GET_PWMSOURCE               0x1d /* 0x00 => Opto-isolated input, 0x01 => GPIO0, 0x02 => GPIO1 */
...
#define TSCAM_IOCONTROLTYPE_GET_INPUT_STATE             0x3c /* Input state: 0 (low level) or 1 (high level) */
#define TSCAM_IOCONTROLTYPE_GET_USER_PULSE_HIGH         0x3e /* User pulse high level time: us */
#define TSCAM_IOCONTROLTYPE_SET_USER_PULSE_HIGH         0x3f
#define TSCAM_IOCONTROLTYPE_GET_USER_PULSE_LOW          0x40 /* User pulse low level time: us */
#define TSCAM_IOCONTROLTYPE_SET_USER_PULSE_LOW          0x41
#define TSCAM_IOCONTROLTYPE_GET_USER_PULSE_NUMBER       0x42 /* User pulse number: default 0 */
#define TSCAM_IOCONTROLTYPE_SET_USER_PULSE_NUMBER       0x43
...
/*
    ...
    when nBitDepth > 8
        nBitCount:  24 => RGB24
                    ...
                    64 => RGB64
*/
TSCAM_API(void)     Tscam_deBayerV2(unsigned nFourCC, int nW, int nH, const void* input, void* output, unsigned char nBitDepth, unsigned char nBitCount);
...
*/
TSCAM_DEPRECATED
TSCAM_API(void)     Tscam_deBayer(unsigned nFourCC, int nW, int nH, const void* input, void* output, unsigned char nBitDepth);

typedef void (__stdcall* PTSCAM_DEMOSAIC_CALLBACK)(unsigned nFourCC, int nW, int nH, const void* input, void* output, unsigned char nBitDepth, void* ctxDemosaic);
